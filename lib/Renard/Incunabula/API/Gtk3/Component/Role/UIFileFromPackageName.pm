...
package Renard::Incunabula::API::Gtk3::Component::Role::UIFileFromPackageName;
...
See the C<ui_file> attribute in L<Renard::Incunabula::API::Gtk3::Component::Role::FromBuilder>.
