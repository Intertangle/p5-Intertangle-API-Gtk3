...
# we can now import
Renard::Incunabula::API::Gtk3::Helper->import;

subtest "Use helper functions" => sub {
	my $val = Renard::Incunabula::API::Gtk3::Helper->gval(int => 512);
	isa_ok( $val, 'Glib::Object::Introspection::GValueWrapper' );

	my $enum = Renard::Incunabula::API::Gtk3::Helper->genum(
...
subtest "Theming" => sub {
	plan skip_all => "Do not need to test theming on Windows"
		unless Renard::Incunabula::API::Gtk3::Helper::_can_set_theme();
	...
	subtest "Set theme" => sub {
		...
		subtest "Try non-existent theme" => sub {
			...
			Renard::Incunabula::API::Gtk3::Helper::_set_theme($try_theme);
...
EOF
	...
	subtest "Set icon-theme" => sub {
		...
		subtest "Try non-existent icon theme" => sub {
			...
			Renard::Incunabula::API::Gtk3::Helper::_set_icon_theme($try_icon_theme);
...
EOF
			...
			Renard::Incunabula::API::Gtk3::Helper::_set_icon_theme($try_theme);
